                ...
                <div className="flex flex-col gap-2 ml-3">
                    {
                        education.map((item, index) => (
                            <div key={index} className="flex flex-wrap gap-2 ml-3">
                                ...
                                <input type="text" className="h-[40px] w-[40%] px-3 py-2 border border-gray-500 outline-none hover:border-black font-semibold text-lg rounded" name="course" value={item.course} onChange={(e) => handleinputchange(index, e)} placeholder="eg: BCA or INTERMEDIATE" required />
