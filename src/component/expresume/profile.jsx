    ...
    return (
        <>
            <div className="h-auto w-[95%] my-2 flex flex-col gap-2 py-2 ">
                ...
                <input type="text" className="h-[40px] w-[80%] md:w-[40%] px-3 py-2 border border-gray-500 outline-none hover:border-black font-semibold text-lg rounded ml-5 " name="link" value={info.link} onChange={handleinfochange} placeholder="eg: github or linkedin link" required />
            </div>
        </>
    )
}