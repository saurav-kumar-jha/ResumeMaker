...
export const ExpResume = () => {
    ...
    return (
        <>
            <section className="h-auto w-[600px] mx-auto  overflow-hidden " id="resume-content" ref={contentRef}>
                <h1 className="text-3xl font-bold text-center uppercase " >Saurav kumar jha</h1>
                <hr className="h-[2px] w-[90%] bg-gray-600 my-2 mx-auto " />
                ...
                <div className="h-auto w-[95%] mx-auto my-2  ">
                    <h2 className="h-auto w-[100%] p-0 uppercase bg-[#add3f8] text-2xl font-semibold text-center ">Summary</h2>
                ...
                <div className="h-auto w-[95%] mx-auto my-2 ">
                    <h2 className="h-auto w-[100%] p-0 uppercase bg-[#add3f8] text-2xl font-semibold text-center ">Profession Experience</h2>
                ...
                <div className="h-auto w-[95%] mx-auto my-2 ">
                    <h2 className="h-auto w-[100%] p-0 uppercase bg-[#add3f8] text-2xl font-semibold text-center ">Education Detail</h2>
                ...
                <div className="h-auto w-[95%] mx-auto my-2 ">
                    <h2 className="h-auto w-[100%] p-0 uppercase bg-[#add3f8] text-2xl font-semibold text-center ">Skills</h2>
            ...
            <button className="h-auto w-auto px-5 py-2 bg-slate-700 rounded-lg my-3 hover:bg-red-500 ml-14 text-white font-bold  " onClick={reactToPrintFn}> Print</button>
        </>
    )
}