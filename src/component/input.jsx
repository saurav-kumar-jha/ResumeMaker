    ...
    return (
        <>
            ...
            <div className="w-full sm:py-4 sm:px-4 sm:flex sm:gap-6 overflow-hidden " >
                <section className="w-auto max-w-[20%] h-fit py-4 px-4 mt-2 sm:mt-4 rounded sm:mx-10">
                    <div className="py-4 mt-4 border rounded shadow-xl">
                        <button className="cursor-pointer h-auto sm:w-auto px-4 flex justify-between items-center gap-2" onClick={() => setshow(!show)}>Explore Section {show ? <ChevronUp /> : <ChevronDown />}</button>
                        {
                            show && (
                    ...
                    <div className="max-w-5xl mx-auto">
                        <form onSubmit={handlesubmit} className="w-full rounded-xl shadow-2xl px-4 sm:px-8 py-6 space-y-6">
                            ...
                            <div className="flex justify-center">
                                <button type="submit" onSubmit={handlesubmit} className="w-[80%] md:w-[60%] lg:w-[40%] px-6 py-3 font-bold text-lg text-white rounded-lg border border-transparent bg-blue-500 hover:bg-blue-600 transition-all duration-300" > SUBMIT </button>
                            </div>
                        </form>
                    </div>
                </section>
