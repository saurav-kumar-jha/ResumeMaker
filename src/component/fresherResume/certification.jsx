            ...
            <div>
                {
                    cer.map((item,index)=>(
                        <div key={index} className="flex flex-col gap-2 mx-3">
                            <input type="text" className="h-[40px] w-[60%] px-3 py-2 border border-gray-500 outline-none hover:border-black font-semibold text-lg rounded" name="name" onChange={(e)=>handleinput(index,e)} value={item.name || ""}  placeholder="Certificate name"  required/>
                            <input type="text" className="h-[40px] w-[60%] px-3 py-2 border border-gray-500 outline-none hover:border-black font-semibold text-lg rounded" name="org" value={item.org || ""} onChange={(e)=>handleinput(index,e)} placeholder="Organization (eg: Udemy)"  required/>
                            <input type="text" className="h-[40px] w-[60%] px-3 py-2 border border-gray-500 outline-none hover:border-black font-semibold text-lg rounded" name="year" value={item.year || ""} onChange={(e)=>handleinput(index,e)} placeholder="Year (eg: 2021)"  required/>
