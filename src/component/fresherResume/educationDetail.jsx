    ...
    return (
        <>
            <div className="h-auto w-[95%]  my-2 py-2 flex flex-col gap-2">
                ...
                <div className="md:flex flex-col gap-2 ml-3">
                    {
                        education.map((item, index) => (
                            <div key={index} className="flex flex-wrap gap-2 ml-3">
                                ...
                                <input type="text" className="h-[40px] w-[80%] md:w-[40%] px-3 py-2 border border-gray-500 outline-none hover:border-black font-semibold text-lg rounded" name="title" value={item.title} onChange={(e) => handleinputchange(index, e)} placeholder="eg: BCA or INTERMEDIATE" required />
