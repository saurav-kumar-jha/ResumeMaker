                ...
                <div className="flex flex-col gap-2 mx-2">
                    {links.map((item, index) => (
                        <div key={index} className="flex flex-wrap gap-2 ml-3">
                            <input type="text" name="platform" className="h-[40px] w-[40%] px-3 py-2 border border-gray-500 outline-none hover:border-black font-semibold text-lg rounded" placeholder="eg: Github" value={item.platform|| ""} onChange={(e) => handleInputChange(index, e)} required />
                            <input type="text" name="url" className="h-[40px] w-[40%] px-3 py-2 border border-gray-500 outline-none hover:border-black font-semibold text-lg rounded" placeholder="eg: https:/github.com/johndeo" value={item.url} onChange={(e) => handleInputChange(index, e)} required/>
